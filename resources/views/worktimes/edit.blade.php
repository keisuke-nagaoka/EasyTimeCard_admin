        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    {{-- 勤務時間登録フォーム --}}
                    <form method="POST" action="{{ route('worktimes.update', ['employeeId' => $employee->id, 'worktimeId' => $worktime->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-control my-4">
                            ...
                            <input type="time" name="start_date" value="{{ $worktime->start_date }}" class="input input-bordered w-full">
                        </div>
                        ...
                        <div class="form-control my-4">
                            ...
                            <input type="time" name="end_date" value="{{ $worktime->end_date }}" class="input input-bordered w-full">
                        </div>
                        ...
                        <div class="form-control my-4">
                            ...
                            <input type="number" name="rest" value="{{ $worktime->rest }}" class="input input-bordered w-full" step="0.01" min="0">
                        </div>
                        ...
                        <div class="form-control my-4">
                            ...
                            <input type="text" name="note" value="{{ $worktime->note }}" class="input input-bordered w-full">
                        </div>

                        <button type="submit" class="btn btn-warning mt-3">更新する　</button>
                    </form>
                </div>
            </div>
        </div>
