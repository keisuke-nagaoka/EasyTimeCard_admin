                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('employees.update', $employee->id) }}">
                        ...
                        <div class="form-control my-4">
                            ...
                            <input type="text" name="name" value="{{ $employee->name }}" class="input input-bordered w-full">
                        </div>
                        ...
                        <div class="form-control my-4">
                            ...
                            <input type="email" name="email" value="{{ $employee->email }}" class="input input-bordered w-full">
                        </div>
                        ...
                        <div class="form-control my-4 relative">
                            ...
                            <input type="password" name="password" class="input input-bordered w-full pr-10" id="password" placeholder="変更する場合のみ入力してください">
                        ...
                        <div class="form-control my-4 relative">
                            ...
                            <input type="password" name="password_confirmation" class="input input-bordered w-full pr-10" id="password_confirmation" placeholder="変更する場合のみ入力してください">
